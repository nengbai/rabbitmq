...
const defaultPort = "cell-1.queue.messaging.ap-tokyo-1.oci.oraclecloud.com:61613"

var serverAddr = flag.String("server", "cell-1.queue.messaging.ap-tokyo-1.oci.oraclecloud.com:61613", "STOMP server endpoint")
var messageCount = flag.Int("count", 10, "Number of messages to send/receive")
var queueName = flag.String("queue", "/queue-demo", "Destination queue")
