...
// 193.122.116.251 131.186.23.190
// const defaultPort = "131.186.23.190:61613"

var serverAddr = flag.String("server", "131.186.23.190:61613", "STOMP server endpoint")
var messageCount = flag.Int("count", 10, "Number of messages to send/receive")
var queueName = flag.String("queue", "/queue/queue-demo", "Destination queue")
var helpFlag = flag.Bool("help", false, "Print help text")
var stop = make(chan bool)

// these are the default options that work with RabbitMQ
var options []func(*stomp.Conn) error = []func(*stomp.Conn) error{
	stomp.ConnOpt.Login("admin", "Pass@word1"),
	stomp.ConnOpt.Host("/"),
}
